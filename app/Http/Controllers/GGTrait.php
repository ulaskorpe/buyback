...
//        $this->lang = $ini_array['lang'];
        ...
        $this->secretKey = env('GG_SECRET');
        $this->nick = env('GG_USERNAME');
        $this->password = env('GG_PW');
        $this->auth_user = env('GG_ROLE_NAME');
        $this->auth_pass = env('GG_ROLE_PW');
        $this->lang = 'tr';
    ...
    public function getPagedSales($startOffset = 0,
                                  $rowCount = 5,
                                  $withData = false,
                                  $byStatus = 'R',
                                  $byUser = 'A',
