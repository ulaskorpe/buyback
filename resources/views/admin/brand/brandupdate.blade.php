            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="update-brand" action="#" method="post"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    @if(!empty($brand['Imagethumb']))
                                        <img id="avatar_img" src="{{url($brand['Imagethumb'])}}">
                                    @endif
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" name="seotitle" id="seotitle" value="{{$brand['Seotitle']}}"
                                           class="form-control h-auto">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" name="seodesc" id="seodesc" value="{{$brand['SeoDesc']}}"
                                           class="form-control h-auto">
...
@section('scripts')
    ...
    <script>
        ...
        $('#update-brand').submit(function (e) {
            ...
            //   swal("ok");
            save(formData, '{{route('brand.brandupdate-post')}}', '', 'btn-1', '');
        });
    </script>
@endsection
