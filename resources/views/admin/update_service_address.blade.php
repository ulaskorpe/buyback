...
<form id="update-address" action="#" method="post"
    ...
    <div class="form-group row">
        <label class="col-lg-2 col-form-label font-weight-semibold">Adres Adı:</label>
        <div class="col-lg-8">
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-8">
            <input type="text" class="form-control" name="phone_number" id="phone_number"
                   value="{{$address['phone_number']}}" data-popup="tooltip" data-trigger="focus"
            >
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-8">
            <input type="text" class="form-control" name="phone_number_2" id="phone_number_2"
                   value="{{$address['phone_number_2']}}" data-popup="tooltip" data-trigger="focus"
            >
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-8">
            <label>
                <input type="checkbox" class="js-switch"  @if($address['active'])  checked @endif name="status2" id="status2" value="13" data-switchery="true"
                       style="display: none;">
    ...
    <div class="text-center">
        <button type="submit" class="btn btn-primary font-weight-bold rounded-round">Adres Ekle
...
<script>
    ...
    $('#update-address').submit(function (e) {
        ...
        if(error){
            ...
            save(formData, '{{route('update-service-address-post')}}', '', '','');
