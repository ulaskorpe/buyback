            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="update-return" action="{{route('return.returnUpdate-post')}}" method="post" enctype="multipart/form-data">
                            {{csrf_field()}}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" name="description" id="description"
                                           value="{{$return['description']}}" data-popup="tooltip" data-trigger="focus"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-2">
                                    <select name="order" id="order" class="form-control">
                                        @for($i=$count;$i>0;$i--)
                                            <option value="{{$i}}" @if($return['order']==$i) selected @endif>{{$i}}</option>
                                        @endfor
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <label>
                                        <input type="checkbox" class="js-switch"  @if($return['status']>0) checked @endif name="status" id="status" value="13" data-switchery="true"
                                               style="display: none;">
                                    </label>
                                </div>
                            </div>
                            ...
                            <!-- /touchspin spinners -->
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary font-weight-bold rounded-round">SORUN GÜNCELLE
...
@section('scripts')
    ...
    <script>
        ...
        $('#update-return').submit(function (e) {
            e.preventDefault();
            ...
            //   swal("ok");
            save(formData, '{{route('return.returnUpdate-post')}}', '', '','');
        });
    </script>
@endsection
