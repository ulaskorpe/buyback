            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="update-model" action="{{route('model.model-update-post')}}" method="post" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <input type="hidden" name="id" id="id" value="{{$model['id']}}">
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label font-weight-semibold">Model Kodu</label>
                                <div class="col-lg-8">
                                    <b>{{$model['code']}}</b>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-8">
                                    <select name="brand_id" id="brand_id" class="form-control">
                                        ...
                                        @foreach($brands as $brand)
                                            <option value="{{$brand['id']}}" @if($model['Brandid']==$brand['id']) selected @endif>{{$brand['BrandName']}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-lg-8">
                                    <select name="cat_id" id="cat_id" class="form-control">
                                        ...
                                        @foreach($categories as $cat)
                                            <option value="{{$cat['id']}}" @if($model['Catid']==$cat['id']) selected @endif>{{$cat['category_name']}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" name="modelname" id="modelname"
                                           value="{{$model['Modelname']}}" data-popup="tooltip" data-trigger="focus"
                                ...
                                <div class="col-lg-8">
                                    <select name="memory_id" id="memory_id" class="form-control">
                                        ...
                                        @foreach($memories as $memory)
                                            <option value="{{$memory['id']}}" @if($model['memory_id'] == $memory['id']) selected @endif>
                                                {{$memory['memory_value']}}GB</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    @if(!empty($model['Imagethumb']))
                                        <img id="avatar_img" src="{{url($model['Imagethumb'])}}">
                                    @endif
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" name="seotitle" id="seotitle" value="{{$model['Seotitle']}}" class="form-control h-auto"  >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" name="seodesc" id="seodesc" value="{{$model['Seodesc']}}" class="form-control h-auto"  >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input type="number" name="min_price" id="min_price" value="{{$model['min_price']}}" class="form-control h-auto"  >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input type="number" name="max_price" id="max_price" class="form-control h-auto" value="{{$model['max_price']}}" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <label>
                                        <input type="checkbox" class="js-switch"   @if($model['Status']==1) checked @endif  name="status" id="status" value="13" data-switchery="true"
                                               style="display: none;">
                            ...
                            <!-- /touchspin spinners -->
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary font-weight-bold rounded-round">MODEL GÜNCELLE
...
@section('scripts')
    ...
    <script>
        ...
        $('#update-model').submit(function (e) {
            e.preventDefault();
            ...
            if(error){
                ...
                save(formData, '{{route('model.model-update-post')}}', '', '','');
            }
        });
    </script>
@endsection
