            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <br><br>
                        <form id="update-memory" action="#" method="post" enctype="multipart/form-data">
                            {{csrf_field()}}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-3">
                                    <input type="number" class="form-control" name="memory_value" id="memory_value"
                                           value="{{$memory['memory_value']}}" data-popup="tooltip" data-trigger="focus"
                                    >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <label>
                                        <input type="checkbox" class="js-switch" @if($memory['Status']==1) checked="true" @endif name="status" id="status" value="13" data-switchery="true"
                                               style="display: none;">
                                    </label>
                                </div>
                            </div>
                            ...
                            <!-- /touchspin spinners -->
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary font-weight-bold rounded-round">HAFIZA GÜNCELLE
...
@section('scripts')
    ...
    <script>
        ...
        $('#update-memory').submit(function (e) {
            e.preventDefault();
            ...
            if ($('#memory_value').val() == '') {
                ...
                $.get("{{url('admin/memory/check-memory')}}/" + $('#memory_value').val()+"/{{$memory['id']}}", function (data) {
                    ...
                    if(data!="ok"){
                        ...
                        save(formData, '{{route('memory.memoryupdate-post')}}', '', '','');
