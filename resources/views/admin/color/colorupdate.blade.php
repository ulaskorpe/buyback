            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="update-color" action="{{route('color.colorUpdate-post')}}" method="post" enctype="multipart/form-data">
                            {{csrf_field()}}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" name="color_name" id="color_name"
                                           value="{{$color['color_name']}}"  data-popup="tooltip" data-trigger="focus"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-3">
                                    <div class="input-group demo2 colorpicker-element">
                                        <input value="{{$color['color_code']}}" data-jscolor="{}" class="form-control" name="color_code" id="color_code">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    @if(!empty($color['sample']))
                                        <img id="avatar_img" src="{{url($color['sample'])}}">
                                    @endif
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <label>
                                        <input type="checkbox" @if($color['status']) checked @endif class="js-switch"  name="status" id="status" value="13" data-switchery="true"
                                               style="display: none;">
                                    </label>
                                </div>
                            </div>
                            ...
                            <!-- /touchspin spinners -->
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary font-weight-bold rounded-round">RENK GÜNCELLE
...
@section('scripts')
    ...
    <script>
        ...
        $('#update-color').submit(function (e) {
            e.preventDefault();
            ...
            //   swal("ok");
            save(formData, '{{route('color.colorUpdate-post')}}', '', '','');
        });
    </script>
@endsection
