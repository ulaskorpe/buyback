...
<div class="row">
    <div class="col-md-12">
        ...
        <form id="create-part" action="{{route('site.create-article-part-post')}}" method="post"
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-8">
                    <label>
                        <input type="checkbox" class="js-switch status_1" checked   name="status" id="status" value="13" data-switchery="true"
                               style="display: none;">
            ...
            <div class="text-center">
                <button type="submit" class="btn btn-primary font-weight-bold rounded-round" onmouseover="fill()">Paragraf EKLE
...
<script>
    ...
    $('#create-part').submit(function (e) {
        ...
        if(error){
            ...
            save(formData, '{{route('site.create-article-part-post')}}', '', '','');
        }
    });
</script>
