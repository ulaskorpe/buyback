            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="update-faq" action="{{route('site.update-faq-post')}}" method="post" enctype="multipart/form-data">
                            {{csrf_field()}}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" name="title" id="title"
                                           value="{{$faq['title']}}" data-popup="tooltip" data-trigger="focus"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <textarea name="content" id="content" class="form-control"> {{$faq['content']}} </textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-1">
                                    <select name="order" id="order" class="form-control">
                                        @for($i=$count;$i>0;$i--)
                                            <option value="{{$i}}" @if($i==$faq['order']) selected @endif>{{$i}}</option>
                                        @endfor
                            ...
                            <!-- /touchspin spinners -->
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary font-weight-bold rounded-round">SSS GÜNCELLE
    ...
    <script>
        ...
        $('#update-faq').submit(function (e) {
            ...
            if(error){
                ...
                save(formData, '{{route('site.update-faq-post')}}', '', '','');
            }
        });
    </script>
@endsection
