...
<div class="content">
    <div class="row">
        <div class="col-md-12">
           ...
           <form id="update-sub-menu" action="{{route('site.update-sub-menu-post')}}" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
               <input type="hidden" name="id" id="id" value="{{$sub_menu['id']}}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        <input type="text" class="form-control" name="title_sub" id="title_sub"
                                data-popup="tooltip" data-trigger="focus" value="{{$sub_menu['title']}}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        <input type="text" class="form-control" name="link_sub" id="link_sub"
                               value="{{$sub_menu['link']}}" data-popup="tooltip" data-trigger="focus"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-2">
                        <select name="order_sub" id="order_sub" class="form-control">
                            @for($i=1;$i<$count;$i++)
                                <option value="{{$i}}" @if($sub_menu['order']==$i) selected @endif>{{$i}}</option>
                            @endfor
                        </select>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        <label>
                            <input type="checkbox" class="js-switch"  @if($sub_menu['status']==1) checked @endif name="status_sub" id="status_sub" value="13" data-switchery="true"
                                   style="display: none;">
                ...
                <div class="text-center">
                    <button type="submit" class="btn btn-primary font-weight-bold rounded-round">MENÜ ALT UNSURU GÜNCELLE
...
<script>
    ...
    $('#update-sub-menu').submit(function (e) {
        e.preventDefault();
        ...
        if(error){
            ...
            save(formData, '{{route('site.update-sub-menu-post')}}', '', '','');
        }
    });
</script>
