            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="create-news" action="{{route('site.create-news-post')}}" method="post" enctype="multipart/form-data">
                            {{csrf_field()}}
                            ...
                            <!-- /touchspin spinners -->
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary font-weight-bold rounded-round">HABER EKLE
    ...
    <script>
        ...
        $('#create-news').submit(function (e) {
            ...
            if(error){
                ...
                save(formData, '{{route('site.create-news-post')}}', '', '','');
            }
        });
    </script>
@endsection
