            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="create-banner" action="{{route('site.create-banner-post')}}" method="post" enctype="multipart/form-data">
                            {{csrf_field()}}
                            ...
                            <!-- /touchspin spinners -->
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary font-weight-bold rounded-round">banner EKLE
...
@section('scripts')
    ...
    <script>
        ...
        $('#create-banner').submit(function (e) {
            e.preventDefault();
            ...
            if(error){
                ...
                save(formData, '{{route('site.create-banner-post')}}', '', '','');
            }
        });
    </script>
@endsection
